// Manual import cards — Zepp/Amazfit app export (.zip).
// Live on the Settings → Imports panel (the file picker opens the OS chooser on
// web and inside the Capacitor app). Posts to the idempotent endpoint, then
// reloads so the new data shows.

import { useRef, useState } from "react";
import { importZepp } from "../api/endpoints";
